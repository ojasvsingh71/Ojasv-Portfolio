    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-20 pb-10">
      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col items-start text-left space-y-6 order-2 lg:order-1">
          ...
          <h2 className="text-2xl md:text-4xl font-semibold text-gray-200 h-10 md:h-12">
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <Link
              href="/projects"
              className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition-all hover:scale-105 shadow-lg shadow-blue-500/25"
            >
            ...
            <Link
              href="/resume"
              className="flex items-center gap-2 px-6 py-3 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-lg font-medium transition-all backdrop-blur-sm"
            >
